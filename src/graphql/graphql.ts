...
> = {
	assignEvent?: Resolver<
		ResolversTypes['Event'],
		ParentType,
		ContextType,
		RequireFields<MutationAssignEventArgs, 'input'>
	>;
...
export type AssignEventMutation = {
	__typename?: 'Mutation';
	assignEvent: {
		__typename?: 'Event';
...
export type UserQuery = {
	__typename?: 'Query';
	user: { __typename?: 'User'; role: UserRole };
};
...
export type UserAllQuery = {
	__typename?: 'Query';
	userAll: Array<{ __typename?: 'User'; role: UserRole }>;
};
